...
public class deleteadd extends HttpServlet
{
	...
	try
	{
		...
		out.println("<tr><td>"+name+"<td>"+nick+"<td>"+addr+"<td><form action=editaddr  method=post><input type=submit name="+addr+" value=Edit></form><form action=deleteadd  method=post><input type=hidden name=del value="+addr+"><input type=submit name=delbtn  value=Delete></form></tr>");
		}
	}catch(Exception e)

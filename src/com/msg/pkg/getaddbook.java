...
public void service(HttpServletRequest req,HttpServletResponse res)throws ServletException,IOException
{
	...
	out.println("<p align=right><a href='addnew.html'>Add</a></p>");
	...
	while(rs.next())
	{
		...
		out.println("<tr><td>"+name+"<td>"+nick+"<td>"+addr+"<td><form action=editaddr  method=post><input type=hidden name=nam value="+name+"><br><input type=hidden name=nic value="+nick+"><br><input type=hidden name=add value="+addr+"><input type=submit name=editadd value=Edit></form><form action=deleteadd  method=post><input type=hidden name=del value="+addr+"><input type=submit name=delbtn  value=Delete></form></tr>");
	}
	}catch(Exception e)

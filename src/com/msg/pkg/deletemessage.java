...
public class deletemessage extends HttpServlet//importing of data present in the httpservlet
{
	...
	//Remaining mails will be displayed on the left frame of the inbox
		...
		out.println("<html><BODY align=center ><form action='deletemessage' method=post><h2>Welcome <FONT COLOR=blue>"+una+" </FONT></h2>");
		out.println("<input type=submit name=t1 value=Delete><h3>Messages in inbox</h3><TABLE  align=center BORDER=0><TR><TH>Check</TH><TH>From</TH><TH>Subject</TH><TH>Date</TH></TR>");
		while(rs.next())
		 {	

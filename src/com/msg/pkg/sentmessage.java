...
public class sentmessage extends HttpServlet
{
	...
	try
	{
		...
		out.println("<html><h2>Welcome "+una);
		...
		while(rs.next())
		{	
			out.println("<TR><TD align=center><INPUT TYPE=CHECKBOX NAME=CB></TD><TD width=300 align=center>"+rs.getString("msgfrom")+"</TD><TD width=300 align=center><A href='compose.html' target=rightf>"+rs.getString("subject")+"</A></TD></TR>");
		}

...
out.println("row deleted");con.commit();
	...
	//Remaining mails
		...
		out.println("<html><BODY BGCOLOR=AQUA><form action='deletefolder' method=post><h2>Mails in <FONT COLOR=PINK>"+fold+"</FONT></h2>");
...
out.println("dat="+dat);
			...
			out.println("<TD width=200 align=center><A href=getmessage?from1="+from+"&dat1="+dat+" target=rightf>"+from+"</A>");

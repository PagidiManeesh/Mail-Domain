...
public class selectfolder extends HttpServlet
{
	...
	try
	{
		...
		con=DriverManager.getConnection("jdbc:mysql://localhost:3306/logindata","root","ROOT");
...
out.println("<html><BODY  align=center ><form action='deletemessage' method=post><h2>Welcome <FONT COLOR=blue>"+una);
		out.println("<input type=submit name=t1 value=Delete><input type=button name=t2 value=Deselect><h3>Messages in inbox</h3><TABLE  align=center BORDER=1><TR><TH>Check</TH><TH>From</TH><TH>Subject</TH><TH>Date</TH></TR>");
		while(rs.next())
		 {	

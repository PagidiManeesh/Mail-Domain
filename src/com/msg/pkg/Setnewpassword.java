...
import javax.servlet.*;
 ...
 public void service(HttpServletRequest req,HttpServletResponse res)throws ServletException,IOException
 {
 	...
 	out=res.getWriter();
 	String s=req.getParameter("oldp");
 	String oldpwd=encry.encryptPlainStrToHex(s);
 	String newp=req.getParameter("newp");
 	String newpwd=encry.encryptPlainStrToHex(newp);
 	...
 	while(rs.next())
 	{
 		...
 		{/*if password satisfies the required fields then it will be changed */
 			...
 			out.println("Your New Pasword was set successfully wants to go for <a href=inbox.html target=rightf><i> Inbox </i></a>");
 			break;
 		}
 		else
